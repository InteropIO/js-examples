(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("@glue42/desktop", [], factory);
	else if(typeof exports === 'object')
		exports["@glue42/desktop"] = factory();
	else
		root["@glue42/desktop"] = factory();
})(this, function() {
...
var activityStatus_1 = __webpack_require__(16);
var activityType_1 = __webpack_require__(10);
var windowType_1 = __webpack_require__(11);
var activity_1 = __webpack_require__(17);
var activityWindow_1 = __webpack_require__(18);
...
var HCBridge = /** @class */ (function () {
    ...
    HCBridge.prototype.registerWindowFactory = function (windowTypeName, factory, parameters) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            // pass create request to HC
            _this._htmlContainer.registerWindowFactory(windowTypeName, factory, 
            /*(info)*/ function () {
                resolve();
            }, function (error) {
                reject(error);
...
var attachedActivityDescriptor_1 = __webpack_require__(49);
...
var Utils = /** @class */ (function () {
    ...
    Utils.getMonitor = function (bounds, displays) {
        var _this = this;
        return displays.map(function (m) {
            var overlap = _this.calculateTotalOverlap({
                left: m.left,
                top: m.top,
                width: m.workingAreaWidth,
                height: m.workingAreaHeight
            }, bounds);
            return {
                monitor: m,
...
var store_1 = __webpack_require__(3);
exports.default = (function (id, options, executor, logger, appManagerGetter, agm) {
    ...
    function snap(target, direction, success, error) {
        ...
        if (typeof target === "string") {
            var targetWindow = store_1.default.get(target);
            if (!targetWindow) {
    ...
    function zoomIn(success, error) {
        return utils_1.default.callbackifyPromise(function () {
    ...
    resultWindow = {
        ...
        get screen() {
            return utils_1.default.getMonitor(resultWindow.bounds, window.glue42gd.monitors);
        },
        maximize: maximize,
        restore: restore,
        minimize: minimize,
        ...
        center: function (screen) { return moveResize(utils_1.default.getDisplayCenterOfScreen(resultWindow.bounds, screen || resultWindow.screen)); },
        close: close,
        snap: snap,
...
var main_3 = __webpack_require__(80);
var main_4 = __webpack_require__(69);
var main_5 = __webpack_require__(63);
var main_6 = __webpack_require__(66);
var pjson = __webpack_require__(32);
...
module.exports = {"name":"@glue42/desktop","description":"Glue42 desktop library","version":"4.6.3","main":"./dist/node/@glue42/desktop.js","browser":"./dist/web/@glue42/desktop.js","types":"./glue.d.ts","homepage":"https://glue42.com/","keywords":["glue","glue42","desktop","interop","context"],"docName":"Glue","scripts":{"init-dev-mode":"node ./build/scripts/init-dev-mode.js","remove-installed-dependencies":"node ./build/scripts/remove-installed-dependencies.js","clean":"node ./build/scripts/clean.js","pre:build":"npm run tslint && tsc && set NODE_ENV=development && npm run clean","tslint":"tslint -t codeFrame ./src/**/*.ts","tslint:fix":"tslint -t codeFrame --fix ./src/**/*.ts","watch":"onchange ./src/**/*.ts -- npm run build:dev","build:dev":"npm run tslint && npm run pre:build && set NODE_ENV=development && webpack","prepublishOnly":"npm run build:prod && npm run test:only","build:prod":"npm run pre:build && set NODE_testENV=development && webpack && set NODE_ENV=production && webpack","build:tests":"tsc -p ./tests/tsconfig.json","test":"npm run tslint && npm run build:dev && npm run test:only","test:only":"npm run build:tests &&  mocha tests/**/*.js --recursive --full-trace","generate-docs":"glue-js-documentation-builder build-reference --project g4e -q reference --modules ./glue.d.ts,./node_modules/@glue42/core/glue.d.ts","generate-docs-new-structure":"glue-js-documentation-builder build-reference --project g4e -q reference --modules ./glue.d.ts,./node_modules/@glue42/core/glue.d.ts --newStructure","publish:beta":"npm publish --tag beta"},"author":{"name":"Glue42","url":"http://www.glue42.com"},"license":"SEE LICENSE IN license.md","dependencies":{"@glue42/core":"4.5.0","callback-registry":"2.5.1","object-assign":"4.1.1","shortid":"2.2.8"},"devDependencies":{"@types/json-stable-stringify":"1.0.32","@types/lodash":"4.14.141","@types/node":"10.7.1","@types/object-assign":"4.0.30","@types/shortid":"0.0.29","@types/mocha":"5.2.7","chai":"4.1.0","glue-js-documentation-builder":"1.1.14","husky":"3.0.5","mocha":"2.4.5","onchange":"3.3.0","readline-sync":"1.4.5","shelljs":"0.6.0","tick42-gateway":"0.2.7","tick42-webpack-config":"4.1.6","tslint":"5.5.0","typescript":"3.0.1","webpack":"2.3.3"},"publishConfig":{"registry":"https://registry.npmjs.com"},"husky":{"hooks":{"pre-commit":"npm run tslint && npm run build:dev"}}}
...
Object.defineProperty(exports, "__esModule", { value: true });
var promiseExtensions_1 = __webpack_require__(8);
var activityManagementAPI_1 = __webpack_require__(44);
var activityAGM_1 = __webpack_require__(9);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var gw3Bridge_1 = __webpack_require__(47);
var hcBridge_1 = __webpack_require__(15);
var activityMyAPI_1 = __webpack_require__(45);
var activityManager_1 = __webpack_require__(48);
var activityAPI_1 = __webpack_require__(43);
var activityAGM_1 = __webpack_require__(9);
var logger_1 = __webpack_require__(4);
var util = __webpack_require__(1);
var promiseExtensions_1 = __webpack_require__(8);
...
var GW3Bridge = /** @class */ (function () {
    function GW3Bridge(connection, logger, contexts, config) {
        ...
        this._gw3Session = connection.domain("activity", logger.subLogger("session:com.tick42.activity"), ["joined", "initiated", "peer-created", "token"]);
        if (typeof window !== "undefined") {
    ...
    GW3Bridge.prototype.registerWindow = function (type, name, independent) {
        ...
        this.invokeCallbacks(this._activityWindowChangeCallbacks, new entityEvent_1.EntityEvent(new activityWindow_1.default(peerId, name, type, undefined, this.getAgmInstance(peerId), independent, this.generateWindowGetter(peerId), undefined), new entityEvent_1.EntityEventContext(entityEvent_1.EntityEventType.Added)), "register window");
    ...
    GW3Bridge.prototype.joinActivity = function (activityId, windowId, name) {
        ...
        return this._gw3Session.send(__assign({ type: gwMmessageJoinActivity, target_id: windowId, activity_id: activityId }, maybeName)).then(function () {
            _this.invokeCallbacks(_this._activityWindowChangeCallbacks, new entityEvent_1.EntityEvent(new activityWindow_1.default(windowId, undefined, undefined, activityId, _this.getAgmInstance(windowId), undefined, _this.generateWindowGetter(windowId), undefined), new entityEvent_1.EntityEventContext(entityEvent_1.EntityEventType.ActivityWindowJoinedActivity)), "activity joined - ActivityWindow");
    ...
    GW3Bridge.prototype.leaveActivity = function (activityId, windowId) {
        ...
        return this._gw3Session.send({
            ...
            _this.invokeCallbacks(_this._activityWindowChangeCallbacks, new entityEvent_1.EntityEvent(new activityWindow_1.default(windowId, undefined, undefined, null, _this.getAgmInstance(windowId), undefined, _this.generateWindowGetter(windowId), undefined), new entityEvent_1.EntityEventContext(entityEvent_1.EntityEventType.ActivityWindowLeftActivity)), "activity left - ActivityWindow");
    ...
    GW3Bridge.prototype.forwardActivityCreatedAndJoinedActivityToActivityWindowEventHandlers = function () {
        ...
        for (var _i = 0, _a = [gwMessageActivityCreated, gwMessageJoinedActivity, gwMessageOwnerChanged]; _i < _a.length; _i++) {
            ...
            this.forwardMessageToEventHandler(activityCreatedMessage, function (msg) {
                return ([msg.owner || __assign({}, msg, { type: msg.peer_type, name: msg.peer_name, peer_id: msg.owner_id })])
                    .concat(msg.participants || [])
                    .map(function (info) { return new activityWindow_1.default(info.peer_id, info.name, info.type, msg.activity_id, _this.getAgmInstance(info.peer_id), undefined, _this.generateWindowGetter(info.peer_id), undefined); });
    ...
    GW3Bridge.prototype.forwardActivityMessagesToStatusEventHandlers = function () {
        ...
        this.forwardMessageToEventHandler(gwMessageOwnerChanged, function (msg) { return [GW3Bridge.activityGwMessageToActivity(msg, new activityStatus_1.ActivityStatus("created", "", new Date()))]; }, function (ent, msg) { return GW3Bridge.activityToActivityStatusChangeEvent(ent); }, this._activityChangeCallbacks);
    };
    ...
    GW3Bridge.prototype.forwardActivityWindowMessagesToEventHandlers = function () {
        ...
        var _loop_1 = function (joinedMessage) {
            this_1.subscribe(joinedMessage, function (msg) {
                ...
                var entity = new activityWindow_1.default(joinedId, joinedName, joinedType /* for ACTIVITY JOINED */, msg.activity_id, _this.getAgmInstance(joinedId), undefined, _this.generateWindowGetter(joinedId), undefined);
        ...
        this.subscribe(gwMessageActivityLeft, function (msg) {
            var entity = new activityWindow_1.default(msg.left_id, undefined, undefined, null, _this.getAgmInstance(msg.left_id), undefined, _this.generateWindowGetter(msg.left_id), undefined);
...
var promiseExtensions_1 = __webpack_require__(8);
var readyMarker_1 = __webpack_require__(19);
var entityObservableCollection_1 = __webpack_require__(50);
var logger_1 = __webpack_require__(4);
var util = __webpack_require__(1);
...
var ActivityManager = /** @class */ (function () {
    ...
    ActivityManager.prototype.createWindow = function (activity, windowTypeOrConfiguration, callback) {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            else if (windowTypeOrConfiguration instanceof windowType_1.default) {
                windowDefinition = {
...
Object.defineProperty(exports, "__esModule", { value: true });
var activityModule_1 = __webpack_require__(46);
...
Object.defineProperty(exports, "__esModule", { value: true });
var application_1 = __webpack_require__(53);
var callback_registry_1 = __webpack_require__(0);
var instance_1 = __webpack_require__(57);
var AppManagerImpl = /** @class */ (function () {
    function AppManagerImpl(_agm, _activities, _windows, _logger, _gdMajorVersion) {
        ...
        this.handleInstanceStarted = function (props) {
            ...
            var instance = new instance_1.default(id, appName, _this, _this._agm, _this._activities, _this._windows);
        ...
        this.handleInstanceStartFailed = function (props) {
            ...
            var instance = new instance_1.default(id, appName, undefined, undefined, undefined, undefined, startFailed);
            _this._updateInstanceFromProps(instance, props);
...
Object.defineProperty(exports, "__esModule", { value: true });
var AgmNames = __webpack_require__(5);
var EventNames = __webpack_require__(54);
var helper_1 = __webpack_require__(12);
...
Object.defineProperty(exports, "__esModule", { value: true });
var app_manager_1 = __webpack_require__(52);
var entitlements_1 = __webpack_require__(56);
var snapshot_1 = __webpack_require__(59);
var data_subscription_1 = __webpack_require__(55);
...
Object.defineProperty(exports, "__esModule", { value: true });
var agm_1 = __webpack_require__(60);
var contexts_1 = __webpack_require__(62);
var channels_1 = __webpack_require__(61);
...
Object.defineProperty(exports, "__esModule", { value: true });
var hotkeys_1 = __webpack_require__(65);
...
var shortid_1 = __webpack_require__(35);
var contextProvider_1 = __webpack_require__(67);
...
Object.defineProperty(exports, "__esModule", { value: true });
var layouts_1 = __webpack_require__(68);
var acsStream_1 = __webpack_require__(70);
var nullStream_1 = __webpack_require__(71);
var callback_registry_1 = __webpack_require__(0);
...
var glue_1 = __webpack_require__(26);
var whatToExpose = glue_1.default;
...
var GDExecutor = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options) {
                            return [2 /*return*/, Promise.reject("The options object is not valid!")];
                        }
                        optionsCopy = __assign({}, options);
                        if (!optionsCopy.targetLocation) {
                            optionsCopy.targetLocation = "bottom";
                        }
                        reformatedOptions = __assign({}, optionsCopy, { popupBounds: optionsCopy.size, targetId: targetWindow.id, popupId: optionsCopy.windowId });
                        return [4 /*yield*/, this.execute("showPopupWindow", {
    ...
    GDExecutor.prototype.createFlydown = function (windowId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.execute("setFlydownArea", { windowId: windowId, options: fullOptions }).then(function () {
                            ...
                            if (options.size instanceof Function && z.flydownSize) {
                                callback = function (data, cancel) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                if (!(options.size instanceof Function)) return [3 /*break*/, 2];
                                                return [4 /*yield*/, options.size(data, cancel)];
                                            case 1:
                                                result = _a.sent();
                                                _a.label = 2;
                                            case 2:
                                                if (!(z.flydownSize instanceof Function && z.flydownSize !== options.size)) return [3 /*break*/, 4];
                                                return [4 /*yield*/, z.flydownSize(data, cancel)];
                                            case 3: return [2 /*return*/, (_a.sent()) || result];
                                            case 4: 
                                            // The options callback overwrites the bounds object specified in the zone
                                            return [2 /*return*/, result || z.flydownSize];
                                        }
                                    });
                                }); };
                            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(this._registry.execute(targetId + "_" + data.flydownId, callbackData, cancelCallback))];
                    case 1:
                        responses = _a.sent();
                        if (responses.length === 1) {
                            ...
                            responseOptions = __assign({}, data, { flydownWindowBounds: response });
    ...
    GDExecutor.prototype.zoomIn = function (window) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute("zoomIn", {
                            windowId: window.id,
                        })];
                    case 1:
                        _a.sent();
    ...
    GDExecutor.prototype.zoomOut = function (window) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute("zoomOut", {
                            windowId: window.id,
                        })];
                    case 1:
                        _a.sent();
    ...
    GDExecutor.prototype.setZoomFactor = function (window, zoomFactor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute("setZoomFactor", {
                            windowId: window.id,
                            options: {
    ...
    GDExecutor.prototype.showDevTools = function (window) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute("showDevTools", {
                            windowId: window.id,
                        })];
                    case 1:
                        _a.sent();
    ...
    GDExecutor.prototype.reformatFlydownOptions = function (windowId, options) {
        ...
        return __assign({}, options, { zones: zones, targetId: windowId, flydownBounds: options.size, flydownActiveArea: options.activeArea });
    };
...
var GDEnvironment = /** @class */ (function () {
    ...
    GDEnvironment.prototype.showPopup = function (windowId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        window = store_1.default.get(windowId);
                        return [4 /*yield*/, this.executor.showPopup(window.API, options)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    GDEnvironment.prototype.createWindow = function (windowId, options) {
        var windowObjAndEvents = window_1.default(windowId, this.mapToWindowConstructorOptions(options), executor_1.default, this._logger, this._appManagerGetter, this._agm);
...
var HcExecutor = /** @class */ (function () {
    ...
    HcExecutor.prototype.moveResize = function (resultWindow, dimensions) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            return _this.agmAction(resultWindow, "T42.Wnd.ResizeAndMove", successHandler, errorHandler, dimensions);
        });
    };
    ...
    HcExecutor.prototype.showPopup = function (targetWindow, options) {
        throw new Error("Not implemented");
    };
    HcExecutor.prototype.createFlydown = function (windowId, options) {
        throw new Error("Method not implemented.");
    };
    HcExecutor.prototype.handleFlydownBoundsRequested = function (targetId, data) {
        throw new Error("Method not implemented.");
    };
    ...
    HcExecutor.prototype.onClosing = function (callback, id) {
        return function () {
        };
    };
    HcExecutor.prototype.onRefreshing = function (callback, id) {
        return function () {
        };
    };
    HcExecutor.prototype.zoomIn = function (resultWindow) {
        // tslint:disable-next-line: no-console
        console.warn("zoomIn method is not supported");
        return Promise.resolve(resultWindow);
    };
    HcExecutor.prototype.zoomOut = function (resultWindow) {
        // tslint:disable-next-line: no-console
        console.warn("zoomIn method is not supported");
        return Promise.resolve(resultWindow);
    };
    HcExecutor.prototype.setZoomFactor = function (resultWindow, factor) {
        // tslint:disable-next-line: no-console
        console.warn("zoomIn method is not supported");
        return Promise.resolve(resultWindow);
    };
    HcExecutor.prototype.showDevTools = function (window) {
...
exports.default = (function (agm, logger, appManagerGetter, cntName, wndId) {
    return new Promise(function (resolve, reject) {
        ...
        function createWindow(windowId, args) {
            var windowObjAndEvents = window_1.default(windowId, mapToWindowConstructorOptions(args), executor_1.default, _logger, appManagerGetter, agm);
            store_1.default.add(windowObjAndEvents);
            return windowObjAndEvents;
        }
        ...
        function createFlydown(targetWindowId, config) {
            throw new Error("Not implemented");
        }
        function showPopup(targetWindowId, config) {
            throw new Error("Not implemented");
        }
        hcEnv = {
            my: my,
